...
\titulo{Mecanismos para Detecção de Funcionamento de Luzes de Balizamento Laterais de
Runways e Taxiways em aeroportos} 
\subtitulo{subtítulo}
\autor{Jedson Cid Nascimento de Brito} \autorcite{Aluno, Nome}
\local{Fortaleza} \uf{CE}
\data{XX de mês de Ano} \ano{2020}
\orientador{Nome do Orientador}  % Nome do orientador. Caso seja uma orientadora use o comando ∖orientador[Orientadora:]{Nome}
\ttorientador{Universidade 7 De Setembro} % Instituição do orientador
...
\instituto{Especialização em Dispositivos Móveis}
\departamento{Departamento de Computação}
\curso{Especialização em Desenvolvimento Dispositivos Móveis}	
